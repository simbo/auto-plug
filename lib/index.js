...
function parseOptions(options, defaultOptions) {
    options = isType('String', options) ? { prefix: options } : (isType('Object', options) ? options : {});
    options.prefix = isType('String', options.prefix) ? options.prefix : defaultOptions.prefix;
